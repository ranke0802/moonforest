...
public static class RpgVFX {
 ...
 public static void Fire(Vector3 origin,Vector3 direction,HitData hit){var o=new GameObject("Energy Ball");o.layer=9;o.transform.position=origin;var b=o.AddComponent<MagicProjectile>();b.direction=direction;b.hit=hit;b.damage=hit.damage;b.power=hit.charge;b.owner=hit.owner;}
...
public sealed class MagicProjectile:MonoBehaviour {
 public bool arrow;public Vector3 direction;public HitData hit;public float power;public int damage;public WitchPlayer owner;float age,trail;RasterEffect image;
