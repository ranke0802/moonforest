...
public sealed class ForestInteractable:MonoBehaviour {
 ...
 public string Dialogue=>kind==Kind.Rest?Loc.T("체력과 마나를 회복했어요. 돌아올 지점도 저장했어요. R키로 이곳으로 돌아오세요.","HP and MP restored. Checkpoint saved. Press R to return here."):kind==Kind.Sign?Loc.T("횃불을 따라가면 슬라임과 꿀벌을 만날 수 있어요. 1: 그림자, 2: 언어, B: 가방, K: 스킬, I: 상태창, Tab: 스킬 선택.","Follow the torches to find slimes and bees. 1: shadows, 2: language, B: bag, K: skills, I: stats, Tab: select skill.","松明に沿ってスライムと蜂を探しましょう。1: 影、2: 言語、I: 状態、B: バッグ、K: スキル、Tab: スキル選択。"):healer?Loc.T("잠시 쉬어 가세요. 체력과 마나를 모두 회복해 드렸어요.","Rest a moment. Your HP and MP are fully restored."):Loc.T("적을 처치해 성장해 보세요. 스킬 선택 후 우클릭으로 시전해요. 30마리를 처치하면 달늑대가 나타나요.","Defeat monsters for XP. Select a skill and right-click to cast. Defeat 30 monsters to face the Moonwolf.","敵を倒して成長しましょう。スキルを選び右クリックで発動。30体倒すと銀月の狼が現れます。");
