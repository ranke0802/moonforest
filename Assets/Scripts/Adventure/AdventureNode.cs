...
public sealed class AdventureNode:MonoBehaviour {
 ...
 public string Label=>Id=="camp"?AdventureProgress.T("캠프 쉼터","Camp refuge","キャンプ休憩所"):Id=="swarm"?AdventureProgress.T("슬라임 무리 · 선택 사건","Slime pack · Optional event","スライム群 · 任意事件"):Id=="gate"?AdventureProgress.T("달늑대 앞 쉼터","Moonwolf refuge","銀月の狼の休憩所"):Id=="elite"?AdventureProgress.T("꿀날개 둥지 · 선택 사건","Honeywing nest · Optional event","蜂の巣 · 任意事件"):Id.StartsWith("herb")?AdventureProgress.T("달빛 약초 채집","Gather moon herb","月光草を採集"):AdventureProgress.T("오염 정화","Cleanse corruption","汚染を浄化");
